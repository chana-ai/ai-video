/**
 * Scene Settings Component Props
 * Shared types for the SceneSettings component and its subcomponents
 */

import { Scene, ProjectDetail } from "../types"
import { Asset, ImageInfo } from "../value-assets/types"
