/**
 * Shared types for projects - scenes, storyboards, and related components
 */
...
// Type for style API response
export interface Style {
  value: string
  label: string
}

// Cached theme and style maps
// These are generated from /api/v2/project/themes API response
export let themeMap: Record<string, Theme> = {}
export let styleMap: Record<string, string> = {
  'cinematic': 'cinematic',
